...
public class ExpAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        final Integer childResource = (Integer) getChild(groupPosition, childPosition);

        if (convertView == null) {
            LayoutInflater infalInflater = (LayoutInflater) this._context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            if (childPosition==0) {
                convertView = infalInflater.inflate(R.layout.list_tem_image, null);
            }
        ...
        if (childPosition==0){
            ...
            imgListChild.setBackgroundResource(childResource);
        }
        else {
            TextView txtListChild = (TextView) convertView
                    .findViewById(R.id.lblListItem);
            txtListChild.setText(childResource);
        }
        return convertView;
    }
